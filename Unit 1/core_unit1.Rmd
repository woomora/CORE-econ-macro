...
- Attendance is not mandatory, but it may influence the professor’s benevolence ;) 
...
**Slave economy**
```{r out.width="50%"}
knitr::include_graphics("https://www.slavevoyages.org/documents//imgs/5AF81DA065049ACE0EC8E236C445F5BC.JPG")
```
]
