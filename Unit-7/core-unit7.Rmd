...
| $ΔQ$ | 1 |
| $ΔP$ | -80 | 
| $\textit{% change in Q}$ | $100 \cdot (1/20) = 5$ |
| $\textit{% change in P}$ | $100 \cdot (-80/6400) = −1.25$
| $\varepsilon$ | $-5/-1.25 = 4$ | 
...
| $ΔQ$ | 1 | 1 |
| $ΔP$ | -80 | -80 | 
| $\textit{% change in Q}$ | $5$ | $2.50$ |
| $\textit{% change in P}$ | $−1.25$ | $-1.67$ |
| $\varepsilon$ | $4$ | $1.5$ |
...
| $ΔQ$ | 1 | 1 | 1 |
| $ΔP$ | -80 | -80 | -80 |  
| $\textit{% change in Q}$ | $5$ | $2.50$ | $1.43$ |
| $\textit{% change in P}$ | $−1.25$ | $-1.67$ | $−3.33$ |
